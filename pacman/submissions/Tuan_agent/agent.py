...
class PacmanAgent(BasePacmanAgent):
    ...
    def __init__(self, **kwargs):
        ...
        # Lưu capture_distance_threshold từ kwargs
        self.capture_distance = kwargs.get('capture_distance_threshold', 1)
    ...
    def a_star_search(self, map_state, start, goal, start_time):
        ...
        while frontier:
            ...
            # Kiểm tra nếu đã đủ gần để bắt giữ (theo capture_distance_threshold)
            distance_to_goal = manhattan_distance(current, goal)
            if distance_to_goal < self.capture_distance:
                return path  # Đã đủ gần để bắt được Ghost
